...
#
    switch2 = None
    while switch2 != 'round2':
        try:
            switch2 = memProxy.getData("switch2")
        except KeyboardInterrupt:
            print('Interrupted')
            sys.exit(0)
        except:
    ...
    #getData
    # print("The emotion of this person is", memProxy.getData("face_emotion"))
    # print("The age of this person is", memProxy.getData("face_age"))
    # print("The gender of this person is", memProxy.getData("face_sex"))
